...
import type { TaskAction, Status } from '../types'
import { taskReducer, initialTasks } from '@utils/taskReducer'
...
export function TaskProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <TaskContext.Provider value={{ tasks, dispatch, filter, setFilter, filteredTasks, stats }}>
      {children}
